...
Original file is located at
    https://colab.research.google.com/drive/1yfsXCmm6Su69Y-lMlQXWVWs_QAzTz9Ys
"""
...
def FINAL(Type,Duration,Budget,TYPE,Ques):
  ...
  jaipur_poi_df = pd.read_csv('jaipur-poi.csv')
  dist_only_matrix_df = pd.read_csv('dist_only_matrix.csv')
  ...
  ## User Matrix
  #(Run for changed input)
  vac_hm_df = pd.read_csv('vac_hm.csv')
  ...
  J_priority_df = pd.read_csv('J_priority_mapping.csv')
  ...
  (sorted_selected_df)
  sorted_selected_df.to_csv('sorted_selected_df.csv')
  ### 
  ...
  #coord_pairs_df.to_csv('coord_pairs.csv')
  ...
  Jaipur_Hotels_df = pd.read_csv('Jaipur_Hotels.csv')
  #Jaipur_Hotels_df.set_index('HID',inplace=True)
  h_lat_df = pd.read_csv('h_lat_df.csv')
  ...
  ## Time Gantt chart
  time_slots_df = pd.read_csv('time_slot_pois.csv')
  time_slots_df.set_index('Section',inplace=True)
  timepois = pd.read_csv('time-pois_new.csv')
  timepois.set_index('PID',inplace=True)
  timepoisnew = pd.read_csv('time-pois_new.csv')
